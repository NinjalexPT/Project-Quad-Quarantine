...
#ifndef QUADQUARANTINE_SWIFT_H
#define QUADQUARANTINE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="QuadQuarantine",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14QuadQuarantine11AppDelegate")
...
@class UIEvent;
@class NSCoder;
SWIFT_CLASS("_TtC14QuadQuarantine9GameScene")
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC14QuadQuarantine18GameViewController")
...
SWIFT_CLASS("_TtC14QuadQuarantine8Joystick")
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC14QuadQuarantine13SceneDelegate")
